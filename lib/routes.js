...
var responsets   = require('response-time')();
...
/**
 * use `response-time` for
 * X-Response-Time on all
 * Response Headers
 */

router.use(responsets);
